# -*- coding: utf-8 -*-
"""
Created on Wed May 28 14:15:02 2025
...
class MyModel(nn.Module):
    def __init__(self, num_classes=10):
        ...
        #SEblock=======================================================================================================
        self.ec1 = ECAAttention(32)
        self.ec2 =ECAAttention(32)
        self.ec3 = ECAAttention(64)
        self.ec4 = ECAAttention(64)
...
val_losses = []
best_accuracy = 0.0  
best_model_path = "C:/Combined/Work/Gauss-2D/ieee_mod/best_mods/best_model_ece32.pth"
...
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.title('Training and Validation Loss over Epochs, ECE 32')
plt.legend()
plt.show()
...
# Example: 3 classes (adjust according to your case)
num_classes = 10
...
plt.title('Multiclass ROC Curve (ECE 32)')
